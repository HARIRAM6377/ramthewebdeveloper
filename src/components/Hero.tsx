...
export const Hero = () => {
  return (
    <section id="home" className="min-h-screen flex items-center justify-between px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto pt-16">
      <div className="flex-1 max-w-2xl">
        <div className="mb-6">
          <div className="w-12 h-1 bg-orange-500 mb-8"></div>
          <h1 className="text-5xl sm:text-6xl font-bold mb-6 leading-tight">
            Hariram <span className="text-orange-500">S</span>
          </h1>
          <p className="text-xl text-gray-400 mb-2">Innovative IT Student</p>
          <h2 className="text-2xl font-semibold text-white mb-6">
            Web Developer & UI/UX Designer
          </h2>
          <p className="text-lg text-gray-300 mb-8 leading-relaxed">
            Passionate about developing smart digital solutions and solving real-world technology challenges. 
            Building efficient, user-centric applications with modern technologies.
          </p>
        </div>
